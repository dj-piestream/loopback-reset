...
declare const LearnLoopbackFourApplication_base: (new (...args: any[]) => {
    projectRoot: string;
...
export declare class LearnLoopbackFourApplication extends LearnLoopbackFourApplication_base {
